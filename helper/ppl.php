...
/*
 |--------------------------------------------------------------------
 |  Personal PHP Library (PPL)
 |  Developed and Maintained by: Gheshman Shakeel
 |  Website: https://geshmanshakeel.site
 |  Contact: personal@geshmanshakeel.site
 |  GitHub:  https://github.com/Gheshman-sh
 |--------------------------------------------------------------------
 |  © 2025 Gheshman Shakeel. All rights reserved.
 |--------------------------------------------------------------------
*/
...
/*
 ...
 |  Overview
 |--------------------------------------------------------------------
 |  This library manages HTTP routing and database operations 
 |  using the MySQLi extension with modern, secure practices.
 |
 |  Key Features:
 |   • Uses prepared statements to prevent SQL injection
 |   • Supports connection pooling for improved performance
 |   • Enables non-blocking operations via Fibers (if available)
 |   • Provides transaction support for grouped queries
 |   • Includes middleware support for route handling
 |   • Serves static files efficiently
 |   • Implements CSRF protection for POST requests
 |   • Supports dynamic route parameters
 |   • Offers pagination for read operations
 |   • Includes partial search capability
 |--------------------------------------------------------------------
*/
